...
<div class="donate-wrapper">
    <div class="donator-information">
        <div class="donate-container-goods" <?php Util::setSession('hide-goods')?>>
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="all-donation">
                ...
                <div class="detail-wrapper">
                    <div class="child-detail">
                        ...
                        <div class="full-name">
                            ...
                            <input type="text" name="middle_name" value="<?= $middleName; ?>" placeholder="Middle Name">
                        </div>
                        <div class="full-name">
                    ...
                    <div class="child-detail">
                        ...
                        <div class="age-gender">
                            ...
                            <input type="text" name="contact" value="<?= $contactNumber; ?>" placeholder="Phone Number" required>
                        </div>
                    </div>
                    <div class="child-detail">
                        <div class="age-gender">
                ...
                <div class="item-wrapper">
                    ...
                    <div class="type-goods">
                        ...
                        <div class="child-type">
                            ...
                            <input name="quantity" type="number" placeholder="Quantity" value="<?= $quantity; ?>" required>
                        </div>
                        <div class="child-type">
                            <label>WEIGHT (approximate) - KG <span class="asterisk">*</span></label>
                            <input name="weight" type="number" placeholder="Weight" value="<?= $weight; ?>" required>
                        </div>
                    </div>
                    <div class="type-goods">
        ...
        <div class="donate-container-money" <?php Util::setSession('show-money')?>>
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="all-donation" enctype="multipart/form-data">
    ...
    <div class="other-side">
        <div class="welcome">
            ...
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="type-donation">
