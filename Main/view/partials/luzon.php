...
<html lang="en">
        ...
        <style>
            * {
            ...
            .map-container {
                display: flex;
                width: 100%;
                height: auto; /* Adjust to fit the SVG */
                overflow: hidden;
                padding: none;
                position: relative;
            ...
            svg {
                ...
                max-width: 100%; /* Constrain SVG to fit within the container */
                display: block; /* Remove any default inline spacing around SVG */
            }
            ...
            .province-indicator span {
                font-size: .7rem;
            }

            .color-box {
                width: 10%; /* Width of the color box */
                height: 80%; /* Height of the color box */
                margin-right: 5%; /* Space between the color box and the province name */
    ...
    <body>
        <form class="map-container" action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
            <div class="color-container">
                ...
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #312313;"></div>
                    <span>Albay</span>
                </div>
                <div class="province-indicator">
                ...
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #6D597A;"></div>
                    <span>Batanes</span>
                </div>
                <div class="province-indicator">
                ...
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #FF9A00;"></div>
                    <span>Benguet</span>
                </div>
                <div class="province-indicator">
                ...
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #2980B9;"></div>
                    <span>Camarines Norte</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #16A085;"></div>
                    <span>Camarines Sur</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #8E44AD;"></div>
                ...
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #FFC300;"></div>
                    <span>Ifugao</span>
                </div>
                <div class="province-indicator">
                ...
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #D5DBDB;"></div>
                    <span>Ilocos Sur</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #A569BD;"></div>
                    <span>Isabela</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #C39BD3;"></div>
                    <span>Kalinga</span>
                </div>
            </div>
                                 
            <input type="hidden" name="province" id="selected_region" value="">
            <svg
            ...
            version="1.1"
            id="svg2"
            viewBox="-70 -60 702.39001 1100.4381"
            ...
            <div class="color-container">
                ...
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #ff008c;"></div>
                    <span>Marinduque</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #FF6F61;"></div>
                    <span>Masbate</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #F1948A;"></div>
                    <span>Mountain Province</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #F7DC6F;"></div>
                    <span>Nueva Ecija</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #5D6D7E;"></div>
                    <span>Nueva Vizcaya</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #A3E4D7;"></div>
                    <span>Mindoro Occidental</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #F4D03F;"></div>
                    <span>Mindoro Oriental</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #E67E22;"></div>
                    <span>Palawan</span>
                ...
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #C1C8C8;"></div>
                    <span>Pangasinan</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #00c3ff;"></div>
                    <span>Quezon</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #F1C40F;"></div>
                ...
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #FADBD8;"></div>
                    <span>Romblon</span>
                </div>
                <div class="province-indicator">
                    <div class="color-box" style="background-color: #F5B041;"></div>
                    <span>Sorsogon</span>
                </div>
                <div class="province-indicator">
        ...
        <script>
            function setProvinceAndSubmit(province) {
                document.getElementById('selected_region').value = province; // Set the hidden input value
                document.querySelector('.map-container').submit(); // Submit the form
            }
        </script>
    </body>
</html>